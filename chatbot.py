...
class Config:
    ...
    API_KEY = "AIzaSyDqA2dB0CY_gMRDf1iM7YsKfEng6t1hZpI"
    ...
    AUDIO_FILE = "https://github.com/MarioSouza18/plataforma/raw/refs/heads/main/assets/assets_audio_paloma_audio.mp3"
    AUDIO_DURATION = 7
